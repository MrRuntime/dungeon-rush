...
func InitWeapons() {
	weapons[WEAPON_SWORD].InitWeapon(NONE, SWORD_FX, NONE)
	...
	weapons[WEAPON_MONSTER_CLAW].InitWeapon(NONE, CLAWFX2, NONE)
	...
	weapons[WEAPON_FIREBALL].InitWeapon(SHINE, HALO_EXPLOSION1, FIREBALL)
	...
	weapons[WEAPON_THUNDER].InitWeapon(BLOOD_BOUND, THUNDER, NONE)
	...
	weapons[WEAPON_THUNDER_STAFF].InitWeapon(NONE, THUNDER_YELLOW, NONE)
	...
	weapons[WEAPON_ARROW].InitWeapon(NONE, HALO_EXPLOSION2, ARROW)
	...
	weapons[WEAPON_POWERFUL_BOW].InitWeapon(NONE, HALO_EXPLOSION2, ARROW)
	...
	weapons[WEAPON_MONSTER_CLAW2].InitWeapon(NONE, CLAWFX, NONE)

	weapons[WEAPON_THROW_AXE].InitWeapon(NONE, CROSS_HIT, AXE)
	...
	weapons[WEAPON_MANY_AXES].InitWeapon(NONE, CROSS_HIT, AXE)
	...
	weapons[WEAPON_SOLID].InitWeapon(NONE, SOLIDFX, NONE)
	...
	weapons[WEAPON_SOLID_GREEN].InitWeapon(NONE, SOLID_GREENFX, NONE)
	...
	weapons[WEAPON_SOLID_CLAW].InitWeapon(NONE, SOLID_GREENFX, NONE)
	...
	weapons[WEAPON_ICEPICK].InitWeapon(NONE, ICESHATTER, ICEPICK)
	...
	weapons[WEAPON_PURPLE_BALL].InitWeapon(NONE, PURPLE_EXP, PURPLE_BALL)
	...
	weapons[WEAPON_PURPLE_STAFF].InitWeapon(NONE, PURPLE_EXP, PURPLE_FIRE_BALL)
	...
	weapons[WEAPON_HOLY_SWORD].InitWeapon(NONE, GOLDEN_CROSS_HIT, NONE)
	...
	weapons[WEAPON_ICE_SWORD].InitWeapon(NONE, ICESHATTER, NONE)
